  ...
  return (
    <div className="rounded-2xl bg-white p-5 shadow-sm shadow-navy/5">
      <div className="mb-5 flex items-start justify-between gap-3">
        ...
        <span className="inline-flex items-center gap-1.5 rounded-full bg-[#ff6b6b]/10 px-3 py-1 text-xs font-semibold text-[#ff6b6b]">
          <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#ff6b6b]" />
          Live
        </span>
      </div>
