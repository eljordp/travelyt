...
const slides: Slide[] = [
  {
    ...
    headline: "Arrive at the airport with less to carry.",
    body: "Your sealed bags meet you at the public ticketing area with a documented custody record. You verify the seal and complete airline check-in.",
  ...
  },
  {
    ...
    body: "Doorstep pickup, sealed transit, and a verified traveler handoff at the public ticketing area — so the family carries less through the terminal.",
  ...
  },
  {
    ...
    body: "Door pickup at home, sealed transit, and coordinated traveler handoff at the airport. Every custody checkpoint stays visible until you receive the bags.",
