    ...
    <div className="min-h-screen bg-[#f5f0ee]">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-28 pb-16">
        ...
        {booking.status === "paid" && (
          <button
            onClick={claim}
            className="w-full py-4 rounded-xl bg-gradient-to-r from-[#c41e2a] to-[#c41e2a] text-white font-bold text-sm hover:opacity-90 transition-opacity cursor-pointer"
          >
            Claim this job
          </button>
        )}
