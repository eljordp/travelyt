                  ...
                  <div className="rounded-xl border border-navy/10 bg-[#f6f7fb] p-4">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm leading-relaxed text-navy/65">Add travelers to this booking. Each traveler may have their own email. Under 18 remains under guardian authorization; other adults verify through their own email and ID. A spouse can be grouped under the primary account.</p>
                      </div>
                      ...
                      {travelers.map((traveler, index) => (
                        <div key={traveler.id} className="rounded-lg border border-navy/10 bg-white p-3">
                          ...
                          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            ...
                            <input aria-label={`Traveler ${index + 2} email`} type="email" placeholder="Their email (optional for minors; required for other adults)" value={traveler.email} onChange={(e) => updateTraveler(traveler.id, { email: e.target.value })} className="rounded-lg border border-gray-200 px-3 py-2 text-sm sm:col-span-2" />
