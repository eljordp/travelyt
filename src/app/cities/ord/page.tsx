...
export const metadata: Metadata = {
  ...
  description:
    "Travelyt door-to-door baggage pickup and airport handoff for Chicago O'Hare and the Chicagoland area.",
  alternates: {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-28 pb-20 bg-gradient-to-b from-navy to-navy/90 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <Link href="/quote?airport=ORD" className="inline-block bg-[#c41e2a] text-white px-8 py-4 rounded-full font-bold hover:bg-[#e63946] transition-colors">
            Get a Quote for ORD
          </Link>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Link href="/quote?airport=ORD" className="inline-block mt-10 bg-[#c41e2a] text-white px-8 py-4 rounded-full font-bold hover:bg-[#e63946] transition-colors">
            Get Your ORD Quote
          </Link>
        </div>
      </section>
