        ...
        <section className="px-6 pb-20">
          <div className="mx-auto grid max-w-6xl gap-5 md:grid-cols-2">
            {demoSteps.map((step) => (
              ...
              >
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-[#ff6868]/10 text-[#ff6868]">
                  {step.icon}
                </div>
                ...
                <div className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#ff6868]">
                  {step.cta}
