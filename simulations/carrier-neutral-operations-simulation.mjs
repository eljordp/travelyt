...
const sourceChecks = [
  ...
  [bookingApi.includes('eventType: "recipient_confirmed"'), "traveler confirmation closes the custody record"],
  ...
  [driverPage.includes('logCustody("carrier_transfer"'), "driver records carrier transfer rather than screening"],
  [!driverPage.includes('logCustody("security_handoff"'), "driver cannot create legacy security-handoff events"],
